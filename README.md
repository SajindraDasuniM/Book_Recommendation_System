...
Created and pickled trained models (SVM, vectorizer, LabelEncoder) for deployment. Designed a user-friendly interactive web app using Streamlit, displaying predicted book subjects and recommended titles. Deployed the app online via Streamlit Cloud, integrated with GitHub for version control.
